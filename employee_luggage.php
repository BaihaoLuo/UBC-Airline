<html>
<head> 
    <title> UBC Airlines - All Luggages </title>
...
<div id=wrapper>
    ...
    <div id=main>
    <h1 style="color:white;">Luggage Information</h1>
<?php
    //helpers:
    ...
    function printModification(){
        ...
        if ($conn=OCILogon($dbusername, $dbpassword, $db)) {
            $query = "select l.LID, l.weight, l.fee, l.ticketNum from Luggage_belongsto l order by LID"; 
    ...
    printModification();
    echo '<form method="POST" action="employee_luggage.php">';
    echo '<br>';
